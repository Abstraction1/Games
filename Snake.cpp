...
do {
	...
	system("CLS");
	system("color 1a");
	for (int i = 10; i > n_len; --i) { my_snake_j.push(i); my_snake_i.push(10); } // ��������� ������� ����.
	while (move != 'q')
	{
		if (_kbhit()) {
			move1 = (char)_getch();
		...
		clone_snake_to_field(mass, snake_mass, a, b); // ���������� ���� ��� ���� �� �������� ����
